        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CustomerPaymentId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTimeScope = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    FreeShippingFromPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfUsesLeft = table.Column<int>(type: "int", nullable: false),
                    CodeAvailabilityEnd = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    DiscountInPercent = table.Column<int>(type: "int", nullable: false),
                    MinimumOrderPrice = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    OrderProductsTotal = table.Column<double>(type: "float", nullable: false),
                    TrackingNumber = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    OrderStatus = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    OrderShippingCost = table.Column<double>(type: "float", nullable: false),
                    ...
                    UserDescription = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    OrderBillId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    MessageToUser = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Bills_OrderBillId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Use = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    NutritionalInformation = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    WeightGram = table.Column<float>(type: "real", nullable: false),
                    Availability = table.Column<bool>(type: "bit", nullable: false),
                    SearchTag = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    ImageUrlLarge = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ImageUrlMain = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ProductAddDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CommentResponse = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductTasteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_ProductTastes_ProductTasteId",
                        column: x => x.ProductTasteId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_ProductTastes_ProductTasteId",
                        column: x => x.ProductTasteId,
                        principalTable: "ProductTastes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_ProductTasteId",
                table: "OrderDetails",
                column: "ProductTasteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderBillId",
                table: "Orders",
                column: "OrderBillId",
                unique: true,
                filter: "[OrderBillId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_ProductTasteId",
                table: "ShoppingCarts",
                column: "ProductTasteId");
        }
