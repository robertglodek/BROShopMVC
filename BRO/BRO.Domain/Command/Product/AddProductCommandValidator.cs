...
namespace BRO.Domain.Command.Product
{
    public class AddProductCommandValidator:AbstractValidator<AddProductCommand>
    {
        public AddProductCommandValidator()
        {
            ...
            RuleFor(n => n.ImageUrlLarge).NotEmpty().WithMessage("Zawartość kolumny nie może być pusta");
            RuleFor(n => n.ImageUrlLarge).MaximumLength(100).WithMessage("Maksymalna liczba znaków pliku: 100");
            RuleFor(n => n.ImageUrlMain).NotEmpty().WithMessage("Zawartość kolumny nie może być pusta");
